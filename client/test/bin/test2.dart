...
Future inputKeyboard(ws) async {
  stdout.write("Enter your text : ");
  var text = stdin.readLineSync();
  ws.add(encode(
      Command.CMD_SEND_MSG, SimpleMessageRequest(topic: "A", message: text)));
}

main() {
  WebSocket.connect('ws://0.0.0.0:9523/').then((WebSocket ws) async {
